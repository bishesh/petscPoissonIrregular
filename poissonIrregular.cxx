...
#undef __FUNCT__
#define __FUNCT__ "computeRhs2dSection"
PetscErrorCode computeRhs2dSection(KSP ksp, Vec b, void *context) {
    PetscErrorCode          ierr;
    PoissonModel            *ctx = (PoissonModel*)context;
    DM                      da;
    DMDALocalInfo           info;
...
//    ierr = DMGetMatrix(dm,&A);CHKERRQ(ierr);
    ...
    if (testPoisson.mDimension == 2) {
#if PETSC_SECTION
        //        computeMatrix2dSection(ksp,A,A,NULL,&testPoisson);
        ...
        ierr = KSPSetComputeRHS(ksp,computeRhs2dSection,(void*)&testPoisson);CHKERRQ(ierr);
#else
